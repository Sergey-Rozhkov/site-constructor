...
export class LayoutComponent extends AbstractComponent {
  ...
  initLayout() {
    ...
    const headerBlockComponent = new HeaderBlockComponent();
    ...
    const footerBlockComponent = new FooterBlockComponent();
  ...
  initShop() {
    ...
    const contentBlockComponent3 = new ContentBlockComponent(ColumnIndex.RIGHT);
